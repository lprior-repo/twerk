...
/// Metrics holds aggregated metrics across all tork components.
...
/// JobMetrics holds metrics about tork jobs.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
...
/// TaskMetrics holds metrics about tork tasks.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
...
/// NodeMetrics holds metrics about tork nodes.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
...
mod tests {
    ...
    fn test_metrics_roundtrip() {
        ...
        assert::close!(parsed.nodes.cpu_percent, 45.5, 0.001);
    }
    ...
    fn test_node_metrics_deserialize() {
        ...
        assert::close!(node.cpu_percent, 50.0, 0.001);
    }
}
