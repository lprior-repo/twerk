...
pub async fn get_registry_credentials(config: &crate::runtime::docker::config::DockerConfig, image: &str) -> Result<Option<DockerCredentials>, DockerError> {
...
pub async fn pull_image(client: &Docker, config: &crate::runtime::docker::config::DockerConfig, images: &std::sync::Arc<tokio::sync::RwLock<std::collections::HashMap<String, std::time::Instant>>>, image: &str, _registry: Option<&Registry>) -> Result<(), DockerError> {
